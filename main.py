...
def get_weather(city_name):
    ...
    headers = {
        ...
        'Referer': 'http://www.weather.com.cn/weather1d/{}.shtml'.format(a),
        'Upgrade-Insecure-Requests': '1',
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5112.81 Safari/537.36 Edg/104.0.1293.54'

    }
    url = "http://www.weather.com.cn/weather/{}.shtml".format(a)
    ...
    #now =list_tem[0]
    now =list_tem[0]+ u"\N{DEGREE SIGN}" + "C"
    ...
    return today_weather, now, today_wind
